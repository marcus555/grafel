      ...
      <div className="flex-1 overflow-y-auto ag-scroll">
        ...
        <div>
          <SectionHeader
            ...
            title="Description"
            infoText="Human-prose description of this endpoint, generated by an LLM from the surrounding code. Edit via the grafel docs skill."
            ...
            <div className="px-4 py-3">
              {detail.description.has_docs ? (
                ...
                <p className="text-sm text-text-4 italic">
                  ...
                  for this group with the grafel docs skill.
                </p>
              )}
            </div>
          )}
...
const PATHS_INSIGHT: InsightValue = {
  ...
  agent: {
    ...
    example:
      "Asked to add a field to the POST /orders payload, an agent calls grafel_endpoints to find the exact handler, confirm it's auth-protected, see the current request-body shape and which database writes it triggers, then edits the right function without grepping for the route.",
  },
};
