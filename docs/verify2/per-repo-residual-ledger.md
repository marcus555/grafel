...
| django-realworld | python | 31 | 6.32% (2026-05-19, post-#526; was 6.42% post-#525, 7.83% python-django-w4) | #526 (python class-attr field entities) — measured delta on top of #525: bug-extractor 47 → 31 (-16), `self.serializer_class` binds to the new Field entity via byMember. #525 prior landed 15 EXTENDS edges (`TimestampedModel`, `AbstractBaseUser`, `PermissionsMixin`, `ConduitJSONRenderer`). Residual: DRF inherited methods `paginate_queryset`/`get_paginated_response` from `ListAPIView` (external-known classification), Django URLConf binder (#527), generic verbs (#529) | at-bar | #527 URLConf, DRF base-class external-known allowlist — path to ~1.8% |
