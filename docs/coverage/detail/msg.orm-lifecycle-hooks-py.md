...
# `msg.orm-lifecycle-hooks-py` — ORM model lifecycle-hook → handler TRIGGERS (Django signals, SQLAlchemy events)
...
(or use `go run ./tools/coverage update msg.orm-lifecycle-hooks-py ...`) then regenerate:
