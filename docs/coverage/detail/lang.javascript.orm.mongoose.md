...
# `lang.javascript.orm.mongoose` — Mongoose
...
|------------|--------|-------------|--------------|-------|-------|
| `model_extraction` | `partial` | `2026-05-28` | — | — | `internal/extractors/cross/ormlink/extractor.go` |
...
(or use `go run ./tools/coverage update lang.javascript.orm.mongoose ...`) then regenerate:
