...
|------------|--------|-------------|-------|-------|-------|
| Dependency graph | 🟢 `partial` | `2026-05-29` | [link](https://github.com/cajasmota/grafel/issues/3216) | `internal/custom/golang/test_frameworks.go` | spec/container/hook patterns are emitted flat with description+focus_state props; nesting (spec->container) and spec->production-call edges are not yet resolved |
