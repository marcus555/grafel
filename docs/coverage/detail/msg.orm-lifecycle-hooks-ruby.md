...
# `msg.orm-lifecycle-hooks-ruby` — ORM model lifecycle-hook → handler TRIGGERS (ActiveRecord callbacks)
...
(or use `go run ./tools/coverage update msg.orm-lifecycle-hooks-ruby ...`) then regenerate:
