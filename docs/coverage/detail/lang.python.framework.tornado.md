...
| Endpoint pagination posture | 🟢 `partial` | `2026-06-02` | 3628 | `internal/engine/http_endpoint_pagination.go`<br>`internal/engine/http_endpoint_pagination_patterns.go`<br>`internal/engine/http_endpoint_pagination_test.go`<br>`internal/engine/http_endpoint_synthesis.go` | #3872 (epic #3628): pythonRequestQueryParams now reads Tornado request idiom self.get_query_argument("limit")/self.get_argument("offset") via pyTornadoArgRe; the RequestHandler.get body is window-reachable from the route anchor. limit+offset stamps offset posture, a lone limit stays unstamped (honest-partial). Verified by TestPagination_Tornado_GetQueryArgLimitOffset (paginated=true, style=offset, params=limit,offset) + TestPagination_Tornado_LoneLimitNotPaginated. PARTIAL: only string-literal argument keys recognised. |
