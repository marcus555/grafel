...
| Env fallback recognition | ✅ `full` | `2026-06-04` | — | `internal/links/constant_propagation.go`<br>`internal/substrate/scala.go`<br>`internal/substrate/scala_pekko_substrate_parity_test.go`<br>`internal/substrate/substrate.go` | Scala constant sniffer (sniffScala) recognises sys.env.getOrElse("VAR", "default") with ProvenanceEnvFallback; framework-agnostic. Value-asserted by TestScalaTapir_ConstantAndEnvAndImport: captures the EXACT tapir env-var + default. Mirrors siblings (full). |
...
| Schema drift detection | ✅ `full` | `2026-06-04` | [link](https://github.com/cajasmota/grafel/issues/2771) | `internal/links/payload_drift.go`<br>`internal/mcp/payload_drift_tool.go`<br>`internal/substrate/payload_shapes.go`<br>`internal/substrate/payload_shapes_scala.go`<br>`internal/substrate/scala_pekko_substrate_parity_test.go` | Scala payload-shape sniffer (sniffPayloadShapesScala) feeds the payload_drift producer/consumer shape comparison; framework-agnostic. Value-asserted by TestScalaTapir_SchemaDrift: the tapir payload shape resolves the EXACT field set. Mirrors the sibling scala frameworks. |
