...
# `msg.orm-lifecycle-hooks-jsts` — ORM model lifecycle-hook → handler TRIGGERS (TypeORM, Sequelize, Mongoose)
...
(or use `go run ./tools/coverage update msg.orm-lifecycle-hooks-jsts ...`) then regenerate:
