...
| Capability | Status | Verified at | Issue | Cites | Notes |
|------------|--------|-------------|-------|-------|-------|
| Tests linkage | 🔴 `missing` | — | [link](https://github.com/cajasmota/grafel/issues/3586) | `internal/custom/java/junit5.go` | android_sdk added to junit5Frameworks map (#3177) |
