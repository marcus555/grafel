...
|------------|--------|-------------|--------------|-------|-------|
| `endpoint_synthesis` | `partial` | `2026-05-28` | — | — | `internal/engine/aspnet_core_routes.go` |
| `handler_attribution` | `partial` | `2026-05-28` | — | — | `internal/engine/aspnet_core_routes.go` |
