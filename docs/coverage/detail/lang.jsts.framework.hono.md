...
| Endpoint pagination posture | 🟢 `partial` | `2026-06-02` | 3628 | `internal/engine/http_endpoint_pagination.go`<br>`internal/engine/http_endpoint_pagination_patterns.go`<br>`internal/engine/http_endpoint_pagination_test.go`<br>`internal/engine/http_endpoint_synthesis.go` | #3872 (epic #3628): jsPaginationVerdict now reads Hono request-query idiom c.req.query("limit")/c.req.query("offset") via jsHonoQueryRe; limit+offset stamps offset posture, a cursor/page token its own style, a lone limit stays unstamped (honest-partial). Verified by TestPagination_Hono_ReqQueryLimitOffset (asserts paginated=true, style=offset, params=limit,offset) + TestPagination_Hono_LoneLimitNotPaginated. PARTIAL: only string-literal query keys are recognised; c.req.query() (all params, dynamic) is not. |
| Endpoint response codes | ✅ `full` | `2026-06-04` | 3818 | `internal/engine/http_endpoint_response_codes.go`<br>`internal/engine/http_endpoint_response_codes_test.go`<br>`internal/engine/http_endpoint_synthesis.go` | #3818: response_codes + success_code + response_codes_source via applyEndpointResponseCodes. Hono signals: c.status(NNN), c.json/text/body/html(x, NNN) 2nd-arg status literal. Honest-partial: dynamic status skipped; no literal -> absent. |
